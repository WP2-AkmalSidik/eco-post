<form id="blog-form" action="{{ route('post.update', ['slug' => $post->slug]) }}" method="POST"
    enctype="multipart/form-data" class="bg-white rounded-lg shadow-sm p-6">
    @csrf
    @method('PUT')
    <!-- Featured Image -->
    <div class="mb-6">
        <div id="image-preview"
            ...
            <img id="selected-image"
                class="{{ $post->image_path ? '' : 'hidden' }} w-full h-full object-cover rounded-lg"
    ...
    @include('user.partials.edit-post.assets.style')
